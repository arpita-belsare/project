...
const Navbar = () => {
  ...
  return (
    <div className="w-dvw	bg-zinc-100 fixed top-0 py-3 px-8 flex justify-between bg-slate-100 z-40 items-center">
      ...
      <div onClick={handleToggleBlur} className="	w-1/2 h-12">
      <div className="h-12 border-2 border-gray-300 border-2 flex border-gray-300" >
      ...
      <nav className="flex w-auto mr-18">
        <ul className="flex w-full justify-end items-center">
          <li className="mx-4 text-black text-xs font-bold">
